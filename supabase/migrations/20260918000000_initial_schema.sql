-- Already applied on the hosted database. Do not edit this file and do not run it again.
-- The next change is a new file in this directory, named YYYYMMDDHHMMSS_short_name.sql.
-- Run new files once, in filename order, in the Supabase SQL editor.
